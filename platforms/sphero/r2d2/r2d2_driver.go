...
func (b *Driver) Dome(heading int16) {
	log.Printf("Dome - heading: %v", heading)
	encoded,_ := EncodeSixShifted(heading)
	b.packetChannel <- b.craftPacket(0x17, 0x0f, append(encoded, 0x00, 0x00))
}
